...
from tiatoolbox_annotation_storage import AnnotationStore, SQLiteStore
from tiatoolbox_utils_env_detection import pixman_warning
from tiatoolbox_utils_exceptions import FileNotSupportedError
from tiatoolbox_utils_misc import imwrite
from tiatoolbox_utils_magic import is_sqlite3
from tiatoolbox_utils_visualization import AnnotationRenderer
from tiatoolbox_wsicore_wsimeta import WSIMeta
    ...
    def save_tiles(
        ...
        *,
        ...
        for iter_tot, (h, w) in enumerate(np.ndindex(vertical_tiles, horizontal_tiles)):
            ...
            if im_aggregate[0]<whiteness[0]-3 and im_aggregate[1]<whiteness[1]-3 and im_aggregate[2]<whiteness[2]-3:
                pass
            else:
                whitePatch = True
